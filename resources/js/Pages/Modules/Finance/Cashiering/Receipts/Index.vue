<template>
    <Head title="Receipts"/>
    <PageHeader title="List of Receipts" pageTitle="List" />
                ...
                <table class="table table-nowrap align-middle mb-0">
                    <thead class="table-light">
                        <tr class="fs-11">
                            ...
                            <th style="width: 10%;" class="text-center">OP Amount</th>
                            <th style="width: 10%;" class="text-center">OR Amount</th>
                            <th style="width: 10%;" class="text-center">Excess</th>
